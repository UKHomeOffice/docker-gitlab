...
sudo -HEu ${GITLAB_USER} sed 's/{{GITLAB_BACKUP_ENCRYPTION_ENABLED}}/'"${GITLAB_BACKUP_ENCRYPTION_ENABLED}"'/' -i config/gitlab.yml
sudo -HEu ${GITLAB_USER} sed 's/{{GITLAB_BACKUP_ENCRYPTION_PASSPHRASE}}/'"${GITLAB_BACKUP_ENCRYPTION_PASSPHRASE}"'/' -i config/gitlab.yml
...
echo 'before ssh' 
sed 's/{{GITLAB_SSH_PORT}}/'"${GITLAB_SSH_PORT}"'/' -i config/gitlab.yml
echo 'done ssh'
